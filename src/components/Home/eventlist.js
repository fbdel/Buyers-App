        ...
        return (
            <li className="list-group-item">
                <div className="col-xs-4 text-center">
                    <p><b>Event Name :</b> {this.props.name}</p>
                    <p><b style={{marginRight:10}}>Event Location :</b>{this.props.location}
                        <b style={{marginLeft:10}}>Event Date :</b>{this.props.eventdate}</p>
                    <div style={{ margin: 10 }}>
